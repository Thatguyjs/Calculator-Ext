...
test("hex(fg)", "Error from 4 to 5: Invalid Hex Value");
test("oct(173)", "123");
test("oct(17710)", "8136");
test("oct(0o17710)", "8136");
test("oct(79)", "Error from 4 to 5: Invalid Octal Value");
test("bin(10)", "2");
test("bin(111)", "7");
test("bin(1111111001000)", "8136");
test("bin(0b1111111001000)", "8136");
test("bin(2)", "Error at 4: Invalid Binary Value");
...
test("convert(2 meters)", "Error from 8 to 15: Missing Parameters", false);
